...
#ONLY TAKE EFFECT WHEN "Start log upon connect" IS UNCHECKED OR IT PROMPTED "LOGGING ALREADY ENABLED";
#ALL OTHER SETTINGS WILL TAKE EFFECT IN GUI EVEN IF "Start log upon connect" IS UNCHECKED.
    currentSession.LogUsingSessionOptions()
